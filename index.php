...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron" style="margin: 10px;">
			...
			<a class="btn btn-primary shadow-lg" role="button" href="<?php echo $latestverlink; ?>">Root (<?php echo $latestver; ?>)</a>            <div class="alert alert-success status" role="alert" style="background-color: rgb(249,249,249);margin: 50px 0 0 0;">
